...
public class ExamScoresTopPerformers {
	...
	public static class PostProcessing extends Mapper<Text, Text,Text, Text > {
	...
	public static Job generateAndConfigureJob(Path in, Path out, Configuration conf) throws IOException {
		...
		//Post Processing
		ChainReducer.addMapper(job, PostProcessing.class, Text.class, Text.class, Text.class, Text.class, conf);
