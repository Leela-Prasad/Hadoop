...
public class SaleAnalysisV1  extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new SaleAnalysisV1(), args);
		System.exit(result);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(SaleAnalysisV1.class);
