...
public class QuestionsWithSomeResponses  {
	...
	public static class Reduce0 extends Reducer<Text, SEWritable,Text,NullWritable> {
	...
	public static class Reduce20 extends Reducer<Text, SEWritable,Text,NullWritable> {
