...
public class ExamScoresTopPerformersV2 {

	
	// Since we are using Sequence File Format and the first MR job output is the input
	// to this MR THEN first MR Reduce Types MUST be SAME AS SECOND MR MAP TYPES.
	// hence changing the type from Text to DoubleWritable.
	public static class MapClass extends Mapper<Text, DoubleWritable,Text, Text > {
