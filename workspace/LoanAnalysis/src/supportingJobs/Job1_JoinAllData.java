...
public class Job1_JoinAllData {
	...
	public static Job generateAndConfigureJob(Path in1, Path in2, Path in3, Path out, Configuration conf) throws IOException, InterruptedException, ClassNotFoundException {
